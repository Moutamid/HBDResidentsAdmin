...
import com.moutamid.hbdresidentsadmin.adapters.UrgentAdapter;
import com.moutamid.hbdresidentsadmin.databinding.ActivityUrgentBinding;
        ...
        Constants.databaseReference().child("complaints")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                            for (DataSnapshot snapshot1 : dataSnapshot.getChildren()){
                                ...
                                if ((model.getType().equals("COMP") && !model.getStatus().equals("COMP")) && model.isUrgent()) {
                                    list.add(model);
                                }
                            }
                        }
                        ...
                        adapter = new UrgentAdapter(UrgentActivity.this, list);
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(UrgentActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
