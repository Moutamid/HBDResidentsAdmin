...
import com.moutamid.hbdresidentsadmin.databinding.ActivityResolvedBinding;
...
public class ResolvedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityResolvedBinding.inflate(getLayoutInflater());
        ...
        Constants.databaseReference().child("complaints")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        adapter = new ComplaintAdapter(ResolvedActivity.this, list);
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(ResolvedActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
